const contractAddress = "0xBBEF25b1A829D8884C746cE17ad8a92acBAE8660"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Noir Agency NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'A community celebrating Black Culture, Fashion, Excellence, and Inclusion. United by a first-of-its-kind collection featuring 2,000 artworks of diverse Black Secret Agents.Created and Illustrated by Aaron Kelly (@iaaronk).';
